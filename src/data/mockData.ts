...
export const companies: Company[] = [
  ...
  { id: 'comp-3', name: 'Meridian Law Partners', industry: 'IP Law', firmSize: '11-50', headcount: 28, website: 'meridianlaw.com', status: 'Prospect', source: 'Podcast', owner: 'Sarah Chen', notes: 'Heard about us from Legal Tech Today podcast.', createdAt: '2025-10-05T09:00:00Z', updatedAt: '2026-01-28T16:30:00Z' },
  ...
  { id: 'comp-5', name: 'Apex Litigation Corp', industry: 'Litigation', firmSize: '200+', headcount: 450, website: 'apexlit.com', status: 'Prospect', source: 'Website', owner: 'Sarah Chen', notes: 'Enterprise prospect. Decision pending Q1 budget.', createdAt: '2025-11-01T14:00:00Z', updatedAt: '2026-02-10T09:00:00Z' },
  ...
  { id: 'comp-7', name: 'Crestview Partners', industry: 'Tax Law', firmSize: '2-10', headcount: 6, website: 'crestviewpartners.com', status: 'Former', source: 'Website', owner: 'Sarah Chen', notes: 'Churned in 2025. Budget constraints.', createdAt: '2024-08-10T10:00:00Z', updatedAt: '2025-08-10T10:00:00Z' },
  ...
  { id: 'comp-9', name: 'Pinnacle Law Firm', industry: 'Corporate Law', firmSize: '51-200', headcount: 150, website: 'pinnaclelaw.com', status: 'Customer', source: 'Referral', owner: 'Sarah Chen', notes: 'Major account. Using enterprise plan.', createdAt: '2025-03-01T08:00:00Z', updatedAt: '2026-01-10T12:00:00Z' },
...
export const opportunities: Opportunity[] = [
  ...
  { id: 'opp-5', companyId: 'comp-3', primaryContactId: 'cont-5', opportunityType: 'New', stageId: 5, source: 'Podcast', dealValue: 36000, forecastCategory: 'Commit', expectedCloseDate: '2026-03-05', contractStartDate: null, contractEndDate: null, closedAt: null, closedReason: null, closedNotes: null, owner: 'Sarah Chen', createdAt: '2025-11-15T09:00:00Z', updatedAt: '2026-02-26T10:00:00Z', stageEnteredAt: '2026-02-20T10:00:00Z' },
...
export const activities: Activity[] = [
  ...
  { id: 'act-2', activityType: 'Call', relatedObjectType: 'Contact', relatedObjectId: 'cont-7', owner: 'Sarah Chen', notes: 'Discovery call — discussed enterprise needs, 450+ users. Budget approved for Q1.', timestamp: '2026-02-24T14:00:00Z' },
  ...
  { id: 'act-5', activityType: 'Meeting', relatedObjectType: 'Opportunity', relatedObjectId: 'opp-5', owner: 'Sarah Chen', notes: 'Final negotiation. Verbal commit received. Sending contract today.', timestamp: '2026-02-26T10:00:00Z' },
  { id: 'act-6', activityType: 'Note', relatedObjectType: 'Contact', relatedObjectId: 'cont-5', owner: 'Sarah Chen', notes: 'Robert confirmed budget allocation. Moving forward with annual plan.', timestamp: '2026-02-15T16:00:00Z' },
  ...
  { id: 'act-10', activityType: 'Meeting', relatedObjectType: 'Opportunity', relatedObjectId: 'opp-3', owner: 'Sarah Chen', notes: 'Enterprise demo with CTO and VP Legal Ops. Showed integration capabilities.', timestamp: '2026-02-20T10:00:00Z' },
  ...
  { id: 'act-13', activityType: 'Meeting', relatedObjectType: 'Opportunity', relatedObjectId: 'opp-7', owner: 'Sarah Chen', notes: 'Renewal signing ceremony. Victoria very happy with platform.', timestamp: '2026-01-28T16:00:00Z' },
  { id: 'act-14', activityType: 'Note', relatedObjectType: 'Contact', relatedObjectId: 'cont-8', owner: 'Sarah Chen', notes: 'Karen mentioned competitor evaluation. Need to accelerate timeline.', timestamp: '2026-02-20T10:00:00Z' },
  ...
  { id: 'act-16', activityType: 'Email', relatedObjectType: 'Contact', relatedObjectId: 'cont-12', owner: 'Sarah Chen', notes: 'Sent renewal confirmation and updated contract.', timestamp: '2026-02-12T15:00:00Z' },
...
export const stageTransitions: StageTransition[] = [
  ...
  { id: 'st-2', opportunityId: 'opp-5', fromStageId: 4, toStageId: 5, transitionedBy: 'Sarah Chen', transitionedAt: '2026-02-20T10:00:00Z', notes: 'Verbal commitment received from Robert.' },
  { id: 'st-3', opportunityId: 'opp-7', fromStageId: 5, toStageId: 6, transitionedBy: 'Sarah Chen', transitionedAt: '2026-01-28T16:00:00Z', notes: 'Contract signed. Renewal complete.' },
  { id: 'st-4', opportunityId: 'opp-8', fromStageId: 4, toStageId: 7, transitionedBy: 'Sarah Chen', transitionedAt: '2025-08-05T10:00:00Z', notes: 'Firm unable to justify budget. Marked lost.' },
  { id: 'st-5', opportunityId: 'opp-3', fromStageId: 3, toStageId: 4, transitionedBy: 'Sarah Chen', transitionedAt: '2026-02-05T11:00:00Z', notes: 'Enterprise demo delivered to CTO team.' },
